let main_gallery = document.getElementById('main_gallery');
 function order(){
     // create sortable and save instance
     let sortable = Sortable.create(main_gallery, {
         animation: 150,
                ...
                <div class="card-body text-secondary">
                    ...
                    <ul class="list-group list-group-flush">
                       <li class="list-group-item">
                            ...
                            <textarea class="container-fluid" id="title[]" name="title[]"></textarea>
                       </li>
                        <li class="list-group-item">
...
let delete_main_gallery_image = function() {
     ...
     let url = '/admin/galleries/delete_main_gallery_image';//Define redirect if needed
     fetch(url, {
         headers: {
...
let delete_main_gallery_block = function(e) {
    ...
    let token = document.querySelector('meta[name="csrf-token"]').getAttribute('content');//Select input values with the data you want to send
    let url = '/admin/galleries/delete_main_gallery_block';//Define redirect if needed
    fetch(url, {
        headers: {
            "Content-Type": "application/json",
            "Accept": "application/json, text-plain, */*",
...
document.addEventListener('DOMContentLoaded', function(){
   ...
   // if(dropify) {
        ...
        Array.from(dropify_clear_buttons).forEach(function (dropify_clear_button) {
            dropify_clear_button.addEventListener('click', delete_main_gallery_image);
        });
   // }
});
