...
(function (global, factory) {
  ...
  var Utils = {
    ...
    parse: {
      ...
      regexp: function regexp(_regexp) {
        ...
        // Test if RegExp is literal, if not, nothing to be done, otherwise, we need to isolate countries and pattern
        if (/^\/.*\/(?:[gimy]*)$/.test(_regexp)) {
          // Replace the regexp literal string with the first match group: ([gimy]*)
          // If no flag is present, this will be a blank string
          flags = _regexp.replace(/.*\/([gimy]*)$/, '$1');
          // Again, replace the regexp literal string with the first match group:
          // everything excluding the opening and closing slashes and the countries
  ...
  UI.Field = {
    ...
    _resetUI: function _resetUI() {
      ...
      // Reset validation countries and last validation result
