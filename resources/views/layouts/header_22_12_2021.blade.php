        ...
        <div class="menu-top container">
            <div class="menu-top-cont callback">
                ...
                <button class="text-r text-r-m text-r-blue callback-btn"
                        onclick="$('#exampleModal6').arcticmodal();">Заказать звонок
                </button>
            </div>
            <a class="logo" href="">
                <picture>
                    <source srcset="{{ asset('dist/img/logo.webp')}}" type="image/webp">
                    <img src="{{ asset('dist/img/logo.png')}}" alt=""></picture>
            </a>
            ...
            <div class="menu-top-cont w15">
                        ...
                        <ul class="submenu">
                            ...
                            <li class="submenu-i">
                                <button class="text-r text-r-m text-r-blue"
                                        onclick="$('#exampleModal4').arcticmodal();">Регистрация
                                </button>
                            </li>
                            <li class="submenu-i">
                                <button class="text-r text-r-m text-r-blue"
                                        onclick="$('#exampleModal5').arcticmodal();">Войти
                                </button>
                            </li>
                            @else
                ...
                <div class="menu-top-cont-c cart">
                    <button class="text-sb" onclick="$('#exampleModal0').arcticmodal();"><i
                                class="icon-shopping_cart"></i><span>{{ count((array) session('cart')) }}</span></button>
                </div>
            </div>
        </div>
