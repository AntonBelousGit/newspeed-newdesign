...
<!--Модальное окно каталог категорий-->
<div style="display: none;">
...
<!--Модальное окно Истории заказво-->
<div style="display: none;">
    <div class="box-modalOrder">
        ...
        <div class="box_modal_body modalOrder_body">
        </div>
    </div>
</div>
<!--Выберите города в оформлении заказа-->
<div style="display: none;">
    <div class="сhooseСity">
        <div class="сhooseСity_title">
            Выберите свой город
            <div class="box-modal_close arcticmodal-close">
                <svg viewBox="0 0 24 24" fill="currentColor" class="icon-0-2-33"><path d="M10.5858 11.9999L4.66667 6.08079C4.27615 5.69027 4.27615 5.0571 4.66667 4.66658C5.0572 4.27606 5.69036 4.27605 6.08088 4.66658L12 10.5857L17.9191 4.66658C18.3096 4.27606 18.9428 4.27606 19.3333 4.66658C19.7239 5.0571 19.7239 5.69027 19.3333 6.08079L13.4142 11.9999L19.3333 17.919C19.7239 18.3096 19.7239 18.9427 19.3333 19.3332C18.9428 19.7238 18.3096 19.7238 17.9191 19.3332L12 13.4141L6.08088 19.3332C5.69036 19.7238 5.0572 19.7238 4.66667 19.3332C4.27615 18.9427 4.27615 18.3096 4.66667 17.919L10.5858 11.9999Z"></path></svg>
            </div>
        ...
        <div class="wrap_list">
            <div class="list_town">
                <div class="lt_item">
                    <div onclick="selectTown(this)">Киев</div>
                </div>
                <div class="lt_item">
                    <div onclick="selectTown(this)">Харьков</div>
                </div>
                <div class="lt_item">
                    <div onclick="selectTown(this)">Одесса</div>
                </div>
                <div class="lt_item">
                    <div onclick="selectTown(this)">Днепр</div>
                </div>
                <div class="lt_item">
                    <div onclick="selectTown(this)">Запорожье</div>
                </div>
                <div class="lt_item">
                    <div onclick="selectTown(this)">Львов</div>
                </div>
            </div>
            <input type="hidden" class="order_town_modal">
            <div class="wrap_input">
                <label>
                    Введите название населенного пункта
                </label>
                <input type="text" id="input_region">
            </div>
        </div>
        <div class="wrap_btns">
            <div class="my_btn btn_main" onclick="closeOrderModal2()">
                Перейти на главную страницу
            </div>
            <div class="my_btn btn_submit" onclick="closeOrderModal()">
                Применить
            </div>
        </div>
    </div>
...
<div style="display: none;">
    @include('frontend.cart.components.cart')
</div>
<!--Модальное окно корзины-->
<div style="display: none;">
    <svg id="svg-scales" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
        <path d="M13.7461 17.4375C13.7461 16.5638 13.0378 15.8555 12.1641 15.8555H5.83594C4.9622 15.8555 4.25391 16.5638 4.25391 17.4375V18H13.7461V17.4375Z" />
        <path d="M16.9453 4.25391V3.19922H10.4849C10.3256 2.75245 9.97411 2.401 9.52734 2.24167V0H8.47266V2.24167C8.02589 2.401 7.67443 2.75245 7.51511 3.19922H1.05469V4.25391H2.37319L0 10.0547C0 11.5085 1.1829 12.6914 2.63672 12.6914H3.69141C5.14522 12.6914 6.32812 11.5085 6.32812 10.0547L3.94421 4.25391H7.51514C7.67447 4.70067 8.02593 5.05213 8.47269 5.21146V
.369L8.05328 12.9765L5.61692 0.803743L3.65581 1.19626ZM6.09189 13.3675C6.22074 14.0163 6.57367 14.599 7.08888 15.0138L8.34302 13.4559C8.19344 13.3354 8.09098 13.1663 8.05357 12.9779L6.09189 13.3675ZM7.08888 15.0138C7.6041 15.4285 8.24878 15.6489 8.91007 15.6362L8.87175 13.6365C8.67976 13.6402 8.4926 13.5763 8.34302 13.4559L7.08888 15.0138ZM8.89091 15.6364H17.7273V13.6364H8.89091V15.6364ZM17.7081 15.6362C18.3694 15.6489 19.0141 15.4285 19.5293 15.0138L18.2752 13.4559C18.1256 13.5763 17.9384 13.6402 17.7464 13.6365L17.7081 15.6362ZM19.5293 15.0138C20.0445 14.599 20.3974 14.0163 20.5263 13.3675L18.5646 12.9779C18.5272 13.1663 18.4247 13.3354 18.2752 13.4559L19.5293 15.0138ZM20.5278 13.3601L21.9823 5.73278L20.0177 5.35813L18.5632 12.9854L20.5278 13.3601ZM21 4.54545H5.54545V6.54545H21V4.54545Z"/>
    </svg>
...
<div style="display: none;">
    <div class="box-comment" id="exampleComment">
        <div class="box_modal_head">
            Оставить отзыв
            <div class="box-modal_close arcticmodal-close">
                <svg viewBox="0 0 24 24" fill="currentColor" class="icon-0-2-33"><path d="M10.5858 11.9999L4.66667 6.08079C4.27615 5.69027 4.27615 5.0571 4.66667 4.66658C5.0572 4.27606 5.69036 4.27605 6.08088 4.66658L12 10.5857L17.9191 4.66658C18.3096 4.27606 18.9428 4.27606 19.3333 4.66658C19.7239 5.0571 19.7239 5.69027 19.3333 6.08079L13.4142 11.9999L19.3333 17.919C19.7239 18.3096 19.7239 18.9427 19.3333 19.3332C18.9428 19.7238 18.3096 19.7238 17.9191 19.3332L12 13.4141L6.08088 19.3332C5.69036 19.7238 5.0572 19.7238 4.66667 19.3332C4.27615 18.9427 4.27615 18.3096 4.66667 17.919L10.5858 11.9999Z"></path></svg>
        ...
        <form class="box_modal_body">
            <div class="wrap_inputs">
                ...
                <div class="wrap_file" >
                    ...
                    <input type="file" onchange="inpFile(this)" multiple>
                </div>
                <label for="c2" class="lp_item1">
                    <div class="custom_checkbox">
                        <input type="checkbox" id="c2">
                        <label for="c2"></label>
                    </div>
                    <div class="label_name">Я рекомендую этот товар </div>
                </label>
            </div>
            <div class="wrap_inputs">
                <label>
                ...
                <label for="c3" class="lp_item1">
                    <div class="custom_checkbox">
                        <input type="checkbox" id="c3">
                        <label for="c3"></label>
                    </div>
                    <div class="label_name">Уведомлять об ответах по электронной почте</div>
                </label>
            </div>
            <div class="wrap_btns">
                <div class="btn_close arcticmodal-close">Отменить</div>
                <button class="my_btn btn_review2">Оставить отзыв</button>
            </div>
            <p class="text_review_modal">
                Чтобы ваш отзыв либо комментарий прошел модерацию и был опубликован, ознакомьтесь, пожалуйста, с
