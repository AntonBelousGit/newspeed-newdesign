...
@section('script')
    ...
    <script src="{{ asset('adminka/assets/bundles/knob.bundle.js')}}"></script><!-- Jquery Knob-->
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-4 col-md-12">
                    ...
                    <div class="fp_row">
                        <label class="pf_title">
                            Текущее фото
                        </label>
                        <div class="wrap-img-profile" id="avatar-crop">
                            <picture><source srcset="{{ asset(Auth::user()->photo) }}" type="image/webp"><img src="{{ asset(Auth::user()->photo) }}" id="profile_photo" alt="img" class="img-fluid"></picture>
                        </div>
                        <label for="input__file" class="title_add_btn">
                            сменить фото
                        </label>
                        <div class="custom_file">
                            <input type="file" name="photo" id="input__file" class="input input__file js-photo-upload" accept="image/*">
                            <input type="hidden" value="" id="hidden_profile_photo_base64" name="hidden_profile_photo_base64" >
                            <label for="input__file" class="custom_add_img_btn"></label>
                        </div>
                    </div>
                    ...
                    <div class="card profile-header">
                        <div class="body text-center">
                            <div class="profile-image mb-3"><img src="{{ asset('adminka/assets/images/user.png')}}" class="rounded-circle" alt=""></div>
                            <div>
                            ...
                            <ul class="right_chat list-unstyled mb-0">
                                <li>
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{ asset('adminka/assets/images/xs/avatar4.jpg')}}" alt="">
                                ...
                                <li>
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{ asset('adminka/assets/images/xs/avatar5.jpg')}}" alt="">
                                            <div class="media-body">
                                ...
                                <li>
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{ asset('adminka/assets/images/xs/avatar2.jpg')}}" alt="">
                                            <div class="media-body">
                                ...
                                <li>
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{ asset('adminka/assets/images/xs/avatar1.jpg')}}" alt="">
                                            <div class="media-body">
                                ...
                                <li>
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{ asset('adminka/assets/images/xs/avatar3.jpg')}}" alt="">
                                            <div class="media-body">
                    ...
                    <div class="tab-content padding-0">
                        <div class="tab-pane blog-page active" id="Overview">
                            ...
                            <div class="card single_post2">
                                <img class="img-fluid" src="{{ asset('adminka/assets/images/blog/blog-page-1.jpg')}}" alt="img">
                                <div class="body">
                                    <div class="content">
                            ...
                            <div class="card single_post2">
                                <img class="img-fluid" src="{{ asset('adminka/assets/images/blog/blog-page-2.jpg')}}" alt="img">
                                <div class="body">
                                    <div class="content">
                                        <div class="actions_sidebar">
                                            <a href="javascript:void(0)"><i class="icon-share"></i></a>
